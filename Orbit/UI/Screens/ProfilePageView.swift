                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    if let personalPrefs = user.personalPreferences {
                        PreferenceSection(
                            ...
                            items: personalPrefs.activitiesHobbies + personalPrefs.friendActivities
                        )
                    }
                    ...
                    if let socialStyle = user.socialStyle {
                        PreferenceSection(
                            title: "Social Style",
                            items: socialStyle.mySocialStyle + [socialStyle.feelAfterMeetup].compactMap { $0 }
                        )
                    }
                    ...
                    if let interactions = user.interactionPreferences {
                        PreferenceSection(
                            ...
                            items: interactions.events + interactions.topics
                        )
                    }
                    ...
                    if let values = user.friendshipValues {
                        PreferenceSection(
                            ...
                            items: values.values + values.idealFriendship + values.qualities
                        )
                    }
                    ...
                    if let situations = user.socialSituations {
                        PreferenceSection(
                            ...
                            items: [situations.feelWhenMeetingNewPeople, situations.socialRole].compactMap { $0 }
                        )
                    }
                }
                .padding(.horizontal)
