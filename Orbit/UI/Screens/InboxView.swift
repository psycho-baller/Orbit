...
struct InboxView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            print("InboxView - onAppear: Loading messages for user \(userVM.currentUser?.accountId ?? "nil")")
            Task {
                isLoading = true
                await msgVM.initializeInbox(for: userVM.currentUser?.accountId) { fetchedConversations in
